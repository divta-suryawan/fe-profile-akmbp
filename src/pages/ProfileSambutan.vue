        ...
        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16">
          ...
          <div data-aos="fade-right" class="relative mx-auto max-w-sm lg:mx-0">
            ...
            <div class="relative mx-auto -mt-8 w-3/4 rounded-2xl bg-white/95 px-5 py-4 text-center shadow-xl shadow-navy/15 backdrop-blur-md ring-1 ring-black/5">
              <p class="font-display text-base font-bold text-navy">Direktur</p>
              <p class="text-xs text-ink/60">Bd. Sriwahyuni, S.ST., M.Kes</p>
            </div>
          </div>
          ...
          <div data-aos="fade-left">
            <div class="relative">
              ...
              <div class="space-y-5 text-base leading-relaxed text-ink/75 sm:text-lg">
                <p>
                  Assalamu'alaikum Warahmatullahi Wabarakatuh,
                </p>
                <p>
                  Puji syukur kehadirat Allah SWT atas limpahan rahmat dan karunia-Nya sehingga kita
                  dapat terus berkhidmat dalam dunia pendidikan, khususnya pendidikan kebidanan di
                  Akademi Kebidanan Mega Buana Palu.
                </p>
                <p>
                  Selamat datang di website resmi Akademi Kebidanan Mega Buana Palu. Website ini
                  hadir sebagai media informasi, komunikasi, dan pelayanan bagi seluruh sivitas
                  akademika, calon mahasiswa, serta masyarakat umum yang ingin mengetahui lebih
                  dalam mengenai aktivitas dan pengembangan institusi kami.
                </p>
                <p>
                  Akademi Kebidanan Mega Buana Palu berkomitmen untuk mencetak lulusan bidan yang
                  kompeten, profesional, dan berakhlak mulia. Kami terus berupaya meningkatkan mutu
                  pendidikan dan pelayanan guna menghasilkan tenaga kesehatan yang unggul dan
                  berdaya saing di era global.
                </p>
                <p>
                  Kepada para calon mahasiswa, kami mengundang Anda untuk bergabung dan menempuh
                  pendidikan di Akademi Kebidanan Mega Buana Palu. Bersama kami, wujudkan impian
                  Anda menjadi tenaga kesehatan yang profesional dan berdedikasi tinggi.
                </p>
                <p>
              ...
              <div class="mt-8 flex items-center gap-4 border-t border-navy/10 pt-6">
                ...
                <div>
                  <p class="font-display text-lg font-bold text-navy">Bd. Sriwahyuni, S.ST., M.Kes</p>
                  <p class="text-sm text-ink/50">Direktur Akademi Kebidanan Mega Buana Palu</p>
                </div>
              </div>
